...
class AdminControllerSpec extends BaseControllersSpec {
  ...
  it should "load styles assets generated by webpack" in {
    //given
    val request = wsUrl(s"$baseUrl/assets/styles/scommons-admin-client-opt.css")
  ...
  it should "load javascript assets generated by webpack" in {
    //given
    val request = wsUrl(s"$baseUrl/assets/scommons-admin-client-opt.js")
  ...
  it should "load admin.html page" in {
    ...
    pageSource should include (s"$baseUrl/assets/styles/scommons-admin-client-opt.css")
    pageSource should include (s"$baseUrl/assets/scommons-admin-client-opt-library.js")
    pageSource should include (s"$baseUrl/assets/scommons-admin-client-opt-loader.js")
    pageSource should include (s"$baseUrl/assets/scommons-admin-client-opt.js")
  }
}
